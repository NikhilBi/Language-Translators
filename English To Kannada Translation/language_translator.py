...
class TranslatorApp:
    def __init__(self, root):
        ...
        self.text_input = tk.Text(self.root, wrap=tk.WORD, width=70, height=20)
        ...
        # Custom translation dictionary (English to Kannada)
        self.translation_dict = {
            "hello": "ನಮಸ್ಕಾರ",
            "how are you": "ನೀವು ಹೇಗಿದ್ದೀರಾ",
            "good morning": "ಶುಭೋದಯ",
            "good afternoon": "ಶುಭಾಪರಾಹ",
            "good evening": "ಶುಭ ಸಾಯಂಕಾಲ",
            "thank you": "ಧನ್ಯವಾದ",
            "please": "ದಯವಿಟ್ಟು",
            "sorry": "ಕ್ಷಮಿಸಿ",
            "how is it going": "ಹೇಗಿದೆ ಹೋಗುತ್ತಿದೆ",
            "see you later": "ನಂತರ ನೋಡೋಣ",
        }
    ...
    def translate_text(self):
        ...
        translated_text, translation_source = self.translate_to_kannada(input_text)
    ...
    def translate_to_kannada(self, text):
        ...
        if any(phrase.lower() in text.lower() for phrase in self.translation_dict):
            ...
            try:
                google_translation = self.translator.translate(text, dest='kn').text
